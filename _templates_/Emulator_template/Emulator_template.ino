 ...
 * -----------------------------------------------------------------------------
 * Filename      : Emulator_template.ino
 * Description   : Template sketch for emulation using external embedded device 
 *                 and virtual plant running on external software.
 * Version       : 01.00
 * Revision      : 00
...
#define SIM_DATA    'D'   // Simulation data
